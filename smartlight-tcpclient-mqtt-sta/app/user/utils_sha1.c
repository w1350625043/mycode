...
void ICACHE_FLASH_ATTR utils_sha1_zeroize(void *v, size_t n)
{
...
void ICACHE_FLASH_ATTR utils_sha1_init(iot_sha1_context *ctx)
{
    memset(ctx, 0, sizeof(iot_sha1_context));
}

void ICACHE_FLASH_ATTR utils_sha1_free(iot_sha1_context *ctx)
{
    if (ctx == NULL) {
        return;
    }
...
void ICACHE_FLASH_ATTR utils_sha1_clone(iot_sha1_context *dst,
 ...
 * SHA-1 context setup
 */
void ICACHE_FLASH_ATTR utils_sha1_starts(iot_sha1_context *ctx)
{
    ctx->total[0] = 0;
    ctx->total[1] = 0;
...
void ICACHE_FLASH_ATTR utils_sha1_process(iot_sha1_context *ctx, const unsigned char data[64])
{
 ...
 */
void ICACHE_FLASH_ATTR utils_sha1_update(iot_sha1_context *ctx, const unsigned char *input, size_t ilen)
{
    size_t fill;
    uint32_t left;
 ...
 * SHA-1 final digest
 */
void ICACHE_FLASH_ATTR utils_sha1_finish(iot_sha1_context *ctx, unsigned char output[20])
{
    uint32_t last, padn;
    uint32_t high, low;
 ...
 */
void ICACHE_FLASH_ATTR utils_sha1(const unsigned char *input, size_t ilen, unsigned char output[20])
{
